    ...
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      ...
      <header className="h-12 border-b border-gray-200 bg-white flex items-center gap-2 px-3 shrink-0">
        ...
        <div className="flex items-center gap-2 mr-1">
          <svg viewBox="0 0 80 80" className="w-5 h-5 shrink-0" aria-hidden="true">
            <path d="M25 5 C45 13 35 27 25 35 C15 43 25 57 45 65 C55 69 55 75 55 75" fill="none" stroke="#ef4444" strokeWidth="2.5" strokeLinecap="round"/>
            <path d="M55 5 C35 13 45 27 55 35 C65 43 55 57 35 65 C25 69 25 75 25 75" fill="none" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
      ...
      <div className="flex flex-1 overflow-hidden">
        <ReactFlowProvider>
          ...
          <DiagramCanvas ref={canvasRef} snapToGrid={snapToGrid} />
          <PropertiesPanel />
        </ReactFlowProvider>
      </div>
